...
from SAPIEN_tests_script.sapien_env import SapienEnv
...
class AntEnv(SapienEnv):
    ...
    def create_ant(scene: sapien.Scene, color=(0.8, 0.6, 0.4), 
        ...
        torso.add_sphere_visual(Pose(), 0.25, material=color)
        torso.add_capsule_collision(Pose([0.141, 0, 0]), 0.08, 0.141, density=density)
        torso.add_capsule_visual(Pose([0.141, 0, 0]), 0.08, 0.141, material=color)
        torso.add_capsule_collision(Pose([-0.141, 0, 0]), 0.08, 0.141, density=density)
        torso.add_capsule_visual(Pose([-0.141, 0, 0]), 0.08, 0.141, material=color)
        rot_z90 = axangle2quat([0, 0, 1], np.pi / 2)
        torso.add_capsule_collision(Pose([0, 0.141, 0], rot_z90), 0.08, 0.141, density=density)
        torso.add_capsule_visual(Pose([0, 0.141, 0], rot_z90), 0.08, 0.141, material=color)
        torso.add_capsule_collision(Pose([0, -0.141, 0], rot_z90), 0.08, 0.141, density=density)
        torso.add_capsule_visual(Pose([0, -0.141, 0], rot_z90), 0.08, 0.141, material=color)
        ...
        thigh_1.add_capsule_visual(Pose(), 0.08, 0.141, material=color)
        ...
        thigh_2.add_capsule_visual(Pose(), 0.08, 0.141, material=color)
        ...
        thigh_3.add_capsule_visual(Pose(), 0.08, 0.141, material=color)
        ...
        thigh_4.add_capsule_visual(Pose(), 0.08, 0.141, material=color)
        ...
        calf_1.add_capsule_visual(Pose(), 0.08, 0.282, material=color)
        ...
        calf_2.add_capsule_visual(Pose(), 0.08, 0.282, material=color)
        ...
        calf_3.add_capsule_visual(Pose(), 0.08, 0.282, material=color)
        ...
        calf_4.add_capsule_visual(Pose(), 0.08, 0.282, material=color)
    ...
    def state_vector(self):
        ...
        pos = torso.pose.p
        quat = torso.pose.q
        vel = torso.linear_velocity
        ang_vel = torso.angular_velocity
    ...
    def _setup_viewer(self):
        ...
        self.viewer.focus_entity(self.actuator.root.entity)
